        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-xl text-yellow-400">GUSSS Daroh</h3>
            </div>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <a href="#" className="hover:text-yellow-400 transition-colors" aria-label="YouTube">
                <Youtube size={20} />
              </a>
            </div>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-lg text-yellow-400 mb-4 pb-2 border-b border-blue-700">Quick Links</h3>
            <ul className="space-y-2">
              {["about", "academics", "faculty", "admissions", "gallery", "events"].map(link => (
                <li key={link}>
                  <Link to={`/${link}`} className="text-gray-200 hover:text-yellow-400 transition-colors capitalize">
          ...
          {/* Contact Information */}
          <div>
            <h3 className="font-bold text-lg text-yellow-400 mb-4 pb-2 border-b border-blue-700">Contact Us</h3>
            <ul className="space-y-4">
              <li className="flex gap-3">
                <MapPin size={18} className="flex-shrink-0 mt-1 text-yellow-400" />
          ...
          {/* School Hours */}
          <div>
            <h3 className="font-bold text-lg text-yellow-400 mb-4 pb-2 border-b border-blue-700">School Hours</h3>
            <ul className="space-y-3">
              <li className="flex gap-3">
                <Clock size={18} className="flex-shrink-0 text-yellow-400" />
                <div>
                  <p className="font-medium text-white">Monday - Saturday</p>
                  <p className="text-gray-200 text-sm">8:00 AM - 3:00 PM</p>
                </div>
              </li>
              <li className="flex gap-3">
                <Clock size={18} className="flex-shrink-0 text-yellow-400" />
